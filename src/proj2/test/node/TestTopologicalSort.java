...
public class TestTopologicalSort {
	...
	public void testSort2CyclicGraph3() throws IOException {
		ArrayList<Node> nodes = new ArrayList<Node>();
		Node node0 = new Node("1-0 0.01 2-0 8-0");
		Node node1 = new Node("2-0 0.01 7-0");
		Node node2 = new Node("3-0 0.01 2-0");
		Node node3 = new Node("4-0 0.01 6-0");
		Node node4 = new Node("5-0 0.01 6-0 3-0");
		Node node5 = new Node("6-0 0.01 5-0 1-0");
		Node node6 = new Node("7-0 0.01 4-0 6-0");
		Node node7 = new Node("8-0 0.01 3-0 5-0");
		Node node8 = new Node("9-0 0.01");

		nodes.add(node0);
		node0.setIndegreeWithinBlock(new HashSet<String>(Arrays.asList(new String[] { "6-0" })));
		nodes.add(node1);
		node1.setIndegreeWithinBlock(new HashSet<String>(Arrays.asList(new String[] { "1-0", "3-0" })));
		nodes.add(node2);
		node2.setIndegreeWithinBlock(new HashSet<String>(Arrays.asList(new String[] { "5-0", "8-0" })));
		nodes.add(node3);
		node3.setIndegreeWithinBlock(new HashSet<String>(Arrays.asList(new String[] { "7-0" })));
		nodes.add(node4);
		node4.setIndegreeWithinBlock(new HashSet<String>(Arrays.asList(new String[] { "6-0", "8-0" })));
		nodes.add(node5);
		node5.setIndegreeWithinBlock(new HashSet<String>(Arrays.asList(new String[] { "4-0", "5-0", "7-0" })));
		nodes.add(node6);
		node6.setIndegreeWithinBlock(new HashSet<String>(Arrays.asList(new String[] { "2-0" })));
		nodes.add(node7);
	...
	public void testSort2CyclicGraph4() throws IOException {
		ArrayList<Node> nodes = new ArrayList<Node>();
		Node node0 = new Node("0-0 0.01 2-0 1-0");
		Node node1 = new Node("1-0 0.01 3-0 4-0");
		Node node2 = new Node("2-0 0.01 5-0");
		Node node3 = new Node("3-0 0.01 6-0 7-0");
		Node node4 = new Node("4-0 0.01 0-0 1-0");
		Node node5 = new Node("5-0 0.01 0-0 1-0");
		Node node6 = new Node("6-0 0.01 3-0");
		Node node7 = new Node("7-0 0.01");
		Node node8 = new Node("8-0 0.01 4-0 5-0 6-0 7-0 9-0");
		Node node9 = new Node("9-0 0.01 3-0 4-0 6-0");

		nodes.add(node0);
		node0.setIndegreeWithinBlock(new HashSet<String>(Arrays.asList(new String[] { "4-0", "5-0" })));
		nodes.add(node1);
		node1.setIndegreeWithinBlock(new HashSet<String>(Arrays.asList(new String[] { "0-0", "4-0", "5-0" })));
		nodes.add(node2);
		node2.setIndegreeWithinBlock(new HashSet<String>(Arrays.asList(new String[] { "0-0" })));
		nodes.add(node3);
		node3.setIndegreeWithinBlock(new HashSet<String>(Arrays.asList(new String[] { "1-0", "6-0", "9-0" })));
		nodes.add(node4);
		node4.setIndegreeWithinBlock(new HashSet<String>(Arrays.asList(new String[] { "1-0", "8-0", "9-0" })));
		nodes.add(node5);
		node5.setIndegreeWithinBlock(new HashSet<String>(Arrays.asList(new String[] { "2-0", "8-0" })));
		nodes.add(node6);
		node6.setIndegreeWithinBlock(new HashSet<String>(Arrays.asList(new String[] { "3-0", "8-0", "9-0" })));
		nodes.add(node7);
